      ...
      <div className="sticky top-0 z-50 bg-gray-950/95 backdrop-blur-sm border-b border-gray-800">
        <div className="flex items-center justify-between h-16 px-4">
          <div className="flex items-center">
            ...
            <h1 className="ml-4 text-xl font-bold text-red-500">
              Juriflix
            </h1>
          </div>
        </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 h-12 bg-gray-800 border-gray-600 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500"
              />
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-3">
                {items.map(item => (
                  ...
                  >
                    ...
                    <div className="p-2">
                      <h3 className="font-medium text-xs line-clamp-2 text-white">{item.nome}</h3>
