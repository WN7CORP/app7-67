...
const AnotacaoCard = ({ anotacao, onEdit, onDelete, onToggleFavorito, obterCorCategoria, formatarData }: any) => (
...
const AnotacaoEditor = ({ anotacao, onSave, onClose, showPreview, onDelete, gerarComIA, aiGenerating, getRootProps, getInputProps, isDragActive, uploading, aplicarFormatacao, textareaRef }: any) => {
